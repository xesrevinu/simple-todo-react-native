import { Activity, Airplay, ChevronDown, ChevronRight, Cloud, Moon, Star, Sun } from "@tamagui/lucide-icons"
    ...
    <ScrollView padding="$4" space>
      <YStack gap="$4">
        <Card elevate bordered padding="$4">
          ...
          <Paragraph>A preview of various Tamagui components</Paragraph>
        </Card>
        ...
        <YStack gap="$4">
          <H2>Progress</H2>
          <Progress value={60} maxWidth={300}>
        ...
        <YStack gap="$4">
          ...
          <Paragraph>Value: {sliderValue}</Paragraph>
        </YStack>
        ...
        <YStack gap="$4">
          <H2>Toggle Group</H2>
          <ToggleGroup value={toggleValue} onValueChange={setToggleValue} type="single">
        ...
        <YStack gap="$4">
          ...
          <XStack gap="$4" alignItems="center">
            ...
            <Checkbox id="checkbox" checked={checked} onCheckedChange={(checked) => setChecked(!!checked)}>
              <Checkbox.Indicator />
            </Checkbox>
          </XStack>
          ...
          <XStack gap="$4" alignItems="center">
            ...
            <Switch id="switch" checked={switchOn} onCheckedChange={(value) => setSwitchOn(value)}>
            ...
            <Select.Content>
              ...
              <Select.Viewport minWidth={200}>
                <Select.Group>
                  ...
                  {["Apple", "Banana", "Orange", "Grape"].map((item, i) => {
                    return (
        ...
        <YStack width="100%" maxWidth={300} marginHorizontal={16}>
        ...
        {/* <XStack alignItems="center" gap="$6">
          ...
          <Avatar circular size="$8">
            ...
            />
            <AvatarFallback delayMs={600} backgroundColor="$blue10" />
          </Avatar>
        </XStack> */}
        <GroupDemo />
        {/* <AccordionDemo /> */}
...
function ListItemDemo1() {
  return (
    <YGroup alignSelf="center" bordered width={240} size="$4">
      <YGroup.Item>
        <ListItem hoverTheme pressTheme icon={Star} title="Star" subTitle="Twinkles" />
      </YGroup.Item>
      <YGroup.Item>
        <ListItem hoverTheme pressTheme icon={Moon}>
          Moon
        </ListItem>
      </YGroup.Item>
      <YGroup.Item>
        <ListItem hoverTheme pressTheme icon={Sun}>
          Sun
        </ListItem>
      </YGroup.Item>
      <YGroup.Item>
        <ListItem hoverTheme pressTheme icon={Cloud}>
          Cloud
        </ListItem>
      </YGroup.Item>
    </YGroup>
...
function TabsDemo() {
  ...
  return (
    ...
    >
      ...
      <XStack alignItems="center" space position="absolute" bottom="$3" left="$4" $maxXs={{ display: "none" }}>
    ...
    <Accordion overflow="hidden" width="$20" type="multiple">
      ...
      <Accordion.Item value="a2">
        ...
        <Accordion.HeightAnimator animation="medium">
          <Accordion.Content animation="medium" exitStyle={{ opacity: 0 }}>
            <Paragraph>
              Eggs have been a dietary staple since time immemorial and there’s good reason for their continued presence
              in our menus and meals.
            </Paragraph>
          </Accordion.Content>
        </Accordion.HeightAnimator>
      </Accordion.Item>
