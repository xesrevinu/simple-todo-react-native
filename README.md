...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/odrLhGNaUu)
...
```sh
npx nx serve simple-todo
```

To create a production bundle:

```sh
npx nx build simple-todo
```

To see all available targets to run for a project, run:

```sh
npx nx show project simple-todo
```
